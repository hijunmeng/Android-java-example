...
/**
 * 用户覆盖YDividerItemDecoration并实现getDivider即可
 */
public abstract class YDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    YDivider getDivider(int itemPosition);
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            YDivider divider = getDivider(itemPosition);
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (divider == null) {
            divider = new YDividerBuilder().create();
        }
